...
class EnableTextMessages extends StatefulWidget {
  const EnableTextMessages({super.key});

  @override
  State<EnableTextMessages> createState() => _EnableTextMessagesState();
}

class _EnableTextMessagesState extends State<EnableTextMessages> {
  int a = 0;
  String phoneNumber = "";
