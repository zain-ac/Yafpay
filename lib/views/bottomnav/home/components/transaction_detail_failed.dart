...
class TransactionsDetailFailed extends StatefulWidget {
  const TransactionsDetailFailed({super.key});

  @override
  State<TransactionsDetailFailed> createState() =>
      _TransactionsDetailFailedState();
}

class _TransactionsDetailFailedState extends State<TransactionsDetailFailed> {
