...
class SubscriptionLink extends StatefulWidget {
  const SubscriptionLink({super.key});

  @override
  State<SubscriptionLink> createState() => _SubscriptionLinkState();
}

class _SubscriptionLinkState extends State<SubscriptionLink> {
  @override
